...
def test_shared_shell_templates_are_tailwind_owned() -> None:
    ...
    assert "data-[state=closed]:[translate:100%]" in sources["templates/header.html"]
    assert "data-[state=open]:[translate:0]" in sources["templates/header.html"]
    assert " translate-x-full " not in sources["templates/header.html"]
